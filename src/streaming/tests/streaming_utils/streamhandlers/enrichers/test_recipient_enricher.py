...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(MarketEvaluationPointType.production.value,
                     1.0,
                     "5790001330584",
                     id="E18 Production is valid"),
        pytest.param(MarketEvaluationPointType.consumption.value,
                     1.0,
                     None,
                     id="E17 Consumption is not valid"),
        pytest.param(MarketEvaluationPointType.exchange.value,
                     1.0,
                     None,
                     id="E20 Exhange is not valid"),
        pytest.param(MarketEvaluationPointType.ve_production.value,
                     1.0,
                     "5790001330584", id="D01 VE Production is valid"),
        pytest.param(MarketEvaluationPointType.surplus_production_group.value,
                     1.0,
                     "5790001330584",
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(MarketEvaluationPointType.consumption.value, 1,
