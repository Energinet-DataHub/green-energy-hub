...
using Energinet.DataHub.MarketData.Domain.MarketEvaluationPoints.Rules;
using Energinet.DataHub.MarketData.Domain.SeedWork;

namespace Energinet.DataHub.MarketData.Domain.MarketEvaluationPoints
{
    public class MarketEvaluationPointMrid : ValueObject
    {
        private MarketEvaluationPointMrid(string value)
        {
            Value = value;
        }
        ...
        public static MarketEvaluationPointMrid Create(string gsrn)
        {
            ...
            return new MarketEvaluationPointMrid(formattedValue);
        }
        ...
        public static BusinessRulesValidationResult CheckRules(string gsrnValue)
        {
            ...
            {
                new MarketEvaluationPointIdMustBeGsrnCompliantRule(gsrnValue),
            });
        }
