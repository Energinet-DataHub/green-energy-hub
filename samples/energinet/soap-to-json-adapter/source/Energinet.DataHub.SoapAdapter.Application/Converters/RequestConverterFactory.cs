...
{
    public sealed class RequestConverterFactory : IRequestConverterFactory
    {
        /// <summary>
        /// Factory for request converters
        /// </summary>
        /// <param name="marketDocumentType">MarketDocument type to get the appropriate converter for</param>
        public IRequestConverter GetConverter(string marketDocumentType)
        {
